...
public extension ISearchService {
    ...
    func filter(query: String,
                page: Int, limit: Int,
                responses: [SearchResponse] = [.products], filters: [Filters] = [.brands, .sellerCategories],
                sort: [String] = [], order: [String] = [],
                hasPromotions: Bool? = nil,
                brands: [String],
                attributeSets: [String] = [],
                minPrice: Double? = nil, maxPrice: Double? = nil,
                saleStatusesNe: [ProductStatus] = [.preorder, .suspend],
        ...
        search(query: query,
               ...
               responses: responses, filters: filters,
               sort: sort, order: order,
               hasPromotions: hasPromotions,
               brands: brands,
               attributeSets: attributeSets,
               minPrice: minPrice, maxPrice: maxPrice,
               saleStatusesNe: saleStatusesNe,
               skus: [],
